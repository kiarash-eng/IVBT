...
G4Tubs* TunicaMedia = new G4Tubs("TunicaMedia",1.5*CLHEP::mm,2.6*CLHEP::mm,30*CLHEP::mm,0.*CLHEP::deg,360.*CLHEP::deg);
G4Tubs* TunicaRemodelling = new G4Tubs("TunicaRemodelling", 1.35*mm,1.5*mm,10*mm,0.*CLHEP::deg,360.*CLHEP::deg);
G4Tubs* TunicaAdventitia = new G4Tubs("TunicaAdventitia",2.6*CLHEP::mm,5*CLHEP::mm,30*CLHEP::mm,0.*CLHEP::deg,360.*CLHEP::deg);
...
G4Tubs* Stent1 = new G4Tubs("Stent1",1.36*CLHEP::mm,1.5*CLHEP::mm,10*CLHEP::mm,87.*CLHEP::deg,6.*CLHEP::deg);
...
G4Tubs* Stent5 = new G4Tubs("Stent5",1.36*CLHEP::mm,1.5*CLHEP::mm,10*CLHEP::mm,267.*CLHEP::deg,6.*CLHEP::deg);
...
G4Tubs* Plaque = new G4Tubs("Plaque",0.85*CLHEP::mm,1.35*CLHEP::mm,5*CLHEP::mm,0.*CLHEP::deg,180.*CLHEP::deg);
