...
SphericalParameterisation::SphericalParameterisation(const G4double stepRadius, const G4double deltaRadius, const G4double deltaTheta)
:G4VPVParameterisation()
,fDeltaTheta(deltaTheta)
,fDeltaRadius(deltaRadius)
,fStepRadius(stepRadius)
{}
